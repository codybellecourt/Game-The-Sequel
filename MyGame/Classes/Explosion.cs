...
namespace Game.Classes
{
    class Explosion : AnimatedSprite
    {
        ...
        {
            Texture = GameEngine.Game.GetTexture("../../../Resources/Images/explosion-spritesheet.png");
            SetUpExplosionAnimation();
            PlayAnimation("explosion", AnimationMode.OnceForwards);

            _boom.SoundBuffer = GameEngine.Game.GetSoundBuffer("../../../Resources/Sounds/boom.wav");
            _boom.Play();
        }
